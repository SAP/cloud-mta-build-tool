...
var buildModuleCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		err := artifacts.ExecuteBuild(buildCmdSrc, buildCmdTrg, buildCmdDesc, buildCmdModule, os.Getwd)
		logError(err)
		return err
	},
	SilenceUsage:  true,
...
var packModuleCmd = &cobra.Command{
	...
	Args:  cobra.NoArgs,
	RunE: func(cmd *cobra.Command, args []string) error {
		err := artifacts.ExecutePack(packCmdSrc, packCmdTrg, packCmdDesc, packCmdModule, os.Getwd)
		logError(err)
		return err
	},
}
